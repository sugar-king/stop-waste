...
Službena stranica: \url{https://www.xm1math.net/texmaker/}
\vspace{8mm}
...
\vspace{5mm}
		...
		\begin{figure}[H]
			\includegraphics[scale=0.8]{slike/rezultati1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
	...
	\end{figure}
		...
		Testiramo mogu li se registrirati dva korisnika s identičnim korisničkim imenom, očekivano ponašanje je bacanje iznimke RequestDeniedException. 
			...
			\begin{figure}[H]
				\includegraphics[scale=0.7]{slike/test6.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
		...
		\begin{figure}[H]
			\includegraphics[scale=0.8]{slike/rezultati2.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
			\caption{Rezultati ispitnih slučaja}
			\label{fig:rez2}
		\end{figure} 
			...
			\begin{figure}[H]
				\includegraphics[scale=0.6]{slike/prije.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
		...
		Pomoću konfiguriranog Chreome drivrera dohvaća se stranica za registraciju i šalju se potrebni podatci za registraciju korisnika, prvim izvođenjem testa email korisnika i korisničko ime su jedinstveni te je očekivani rezultat uspješna registracija.
			...
			\begin{figure}[H]
				\includegraphics[scale=1.1]{slike/sel1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			\begin{figure}[H]
				\includegraphics[scale=1.1]{slike/sel2.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			\begin{figure}[H]
				\includegraphics[scale=1.1]{slike/sel3.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			\begin{figure}[H]
				\includegraphics[scale=1.1]{slike/sel4.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			\begin{figure}[H]
				\includegraphics[scale=1.1]{slike/sel5.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			\begin{figure}[H]
				\includegraphics[scale=1.1]{slike/sel6.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
		...
		\begin{figure}[H]
			\includegraphics[scale=0.8]{slike/rezultati.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
			\caption{Rezultati ispitnih slučaja}
			\label{fig:rez}
		\end{figure} 

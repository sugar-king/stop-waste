...
\addcontentsline{toc}{chapter}{Dodatak: Prikaz aktivnosti grupe}
		...
		\section*{Tablica aktivnosti}
			...
			\begin{longtabu} to \textwidth {|X[7, l]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|}
				...
				Upravljanje projektom 		& 6 & 1 &  & 3  &  &  & \\ \hline
		...
		\eject
			...
			\begin{figure}[H]
				\includegraphics[scale=0.5]{slike/grupa.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
		...
		\begin{figure}[H]
			\includegraphics[scale=0.9]{slike/pojedinac.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering

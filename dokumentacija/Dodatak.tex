...
\addcontentsline{toc}{chapter}{Dodatak: Prikaz aktivnosti grupe}
		...
		\section*{Tablica aktivnosti}
			...
			\begin{longtabu} to \textwidth {|X[7, l]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|}
				...
				Upravljanje projektom 		& 5 & 1 &  & 2  &  &  & \\ \hline
				Opis projektnog zadatka 	&  &  & 2 &  &  & 2 & \\ \hline
				
				Funkcionalni zahtjevi       &  & 2 &  &  &  &  & 8 \\ \hline
				...
				\textit{npr. izrada početne stranice} 				&  &  & 3 &  & 3 &  & 20 \\ \hline 
				\textit{izrada baze podataka} 		 			&  & 1 &  &4  &  &  & \\ \hline 
				\textit{spajanje s bazom podataka} 							&  &  &  & 1 &  &  &  \\ \hline
				\textit{back end} 							&  & 10 & 4 &  &  & 6 &  \\  \hline
				 							&  &  &  &  &  &  &\\  \hline
